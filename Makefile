...
help:
	...
	@echo "  make release VERSION=patch    # Auto-bump patch (1.0.4 -> 1.0.5)"
	@echo "  make release VERSION=minor    # Auto-bump minor (1.0.4 -> 1.1.0)"
	@echo "  make release VERSION=major    # Auto-bump major (1.0.4 -> 2.0.0)"
	@echo "  make release VERSION=1.2.3    # Use explicit version"
	@echo ""
